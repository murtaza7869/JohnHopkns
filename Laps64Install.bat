bitsadmin.exe /transfer "Laps" https://github.com/murtaza7869/JohnHopkns/raw/main/LAPS.x64.msi %WinDir%\LAPS.x64.msi
MSIEXEC.EXE /I "%WinDir%\LAPS.x64.msi" /qn /l* %WinDir%\LAPSx64-6.2_Client-Install.log
